...
/*
smooth interpolation factor.  'order' number of derivatives
are zero when f is 0 or 1.  currently up to 5 is supported.

code originaly generated via s-power series, which in turn
is a generalization of a hermite interpolant.
*/
