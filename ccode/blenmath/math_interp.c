...
float BLI_smoothstep(float f, int order) {
	switch (order) {
		case 0: { //linear
			return f;
		}
		...
		case 2: {
			float f3=f*f*f, f4=f3*f, f5 = f4*f;
			return 6.0f*f5 - 15.0f*f4 + 10.0f*f3;
		}
		case 3: {
			float f2=f*f, f3=f2*f, f4=f3*f, f5 = f4*f;
			return (70.0f*f4-315.0f*f3+540.0f*f2-420.0f*f+126.0f)*f5;
		}
		case 4: {
			float f2=f*f, f3=f2*f, f4=f3*f, f5 = f4*f, f6=f5*f;
			return -(2.520f*f5-13.860f*f4+30.800f*f3-34.650f*f2+19.800f*f-4.620f)*f6*100.0f;
		}
		case 5: {
			float f2=f*f, f3=f2*f, f4=f3*f, f5 = f4*f, f6=f5*f, f7=f6*f;
			return (0.9240f*f6-6.0060f*f5+16.3800f*f4-24.0240f*f3+20.0200f*f2-9.0090f*f+1.7160f)*f7*1000.0f;
		}
		default:
			return -1.0f;
	}
